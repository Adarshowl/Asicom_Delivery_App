...
const CancelledDelivery = ({ navigation }) => {
  ...
  const getAllShop = () => {
    setLoading(true);
    try {
      console.log("response axios >>> ", JSON.stringify(API_END_POINTS.cancelled_delivery));

      ApiCall('get', null, API_END_POINTS.cancelled_delivery, {
